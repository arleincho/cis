...
<body id="page" class="page <?php echo $this['config']->get('body_classes'); ?>">
    ...
    <?php if(($_SERVER['QUERY_STRING'] != '') && ($_REQUEST['id'] == '41')) :?>
<div style="float: left; width:980px;">
		<div style="float:left;">
			<?php if ($this['modules']->count('innerslide')):?>
	...
	<div id="block-footer" class="clearfix">
		...
		<div class="wrapper">
			...
			<footer id="footer" class="grid-block">
				...
				<a id="logo-footer" href="<?php echo $this['config']->get('site_url'); ?>"><?php echo $this['modules']->render('logo-footer'); ?></a>
