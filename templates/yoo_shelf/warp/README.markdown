...
## Changelog
	...
	^ Changed readmore button CSS class (J15+J16)
	...
	# Fixed margin of system messages (J15+J16)
	# Fixed images-off menu parameter (J15+J16)
	...
	^ Updated jQuery to 1.6.1 (J15+J16)
